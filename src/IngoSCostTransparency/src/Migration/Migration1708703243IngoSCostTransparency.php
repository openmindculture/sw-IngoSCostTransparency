...
CREATE TABLE IF NOT EXISTS `ingo_s_cost_transparency_extension` (
    ...
    `cost_transparency_percentage_01` TINYINT NULL,
    `cost_transparency_percentage_02` TINYINT NULL,
    `cost_transparency_percentage_03` TINYINT NULL,
    `cost_transparency_percentage_04` TINYINT NULL,
    `cost_transparency_percentage_05` TINYINT NULL,
